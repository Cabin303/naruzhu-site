...
function syncPlayButton(){ const isPlaying=!audio.paused; playButton.textContent=isPlaying?'Ⅱ':'▶'; playButton.setAttribute('aria-label',isPlaying?'Пауза':'Воспроизвести'); }
